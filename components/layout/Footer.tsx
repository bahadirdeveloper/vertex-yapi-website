          ...
          <div className="lg:col-span-2">
            <Link href="/" className="inline-block mb-8">
              <div className="flex items-center space-x-3">
                ...
                />
                <div>
                  <h3 className="text-2xl font-bold text-white" style={{ textRendering: 'optimizeLegibility', WebkitFontSmoothing: 'antialiased', MozOsxFontSmoothing: 'grayscale', fontFeatureSettings: "'kern' 1, 'liga' 1" }}>VERTEX YAPI</h3>
                  <p className="text-orange-400 text-sm font-medium" style={{ textRendering: 'optimizeLegibility', WebkitFontSmoothing: 'antialiased', MozOsxFontSmoothing: 'grayscale', fontFeatureSettings: "'kern' 1, 'liga' 1" }}>CONSTRUCTION COMPANY</p>
                </div>
              </div>
            </Link>
